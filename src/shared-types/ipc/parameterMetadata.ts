...
const META: Record<string, PartialMeta> = {
  // Battery
  BATT_MONITOR: { shortDescription: 'Battery monitoring type', units: '', enumValues: { 0: 'Disabled', 3: 'Analog Voltage and Current', 4: 'Analog Voltage Only', 5: 'Solo', 6: 'Bebop', 7: 'SMBus-Generic', 8: 'UAVCAN-BatteryInfo' } },
  ...
  // Failsafe
  FS_THR_ENABLE: { shortDescription: 'Throttle failsafe action', units: '', enumValues: { 0: 'Disabled', 1: 'Always RTL', 2: 'Continue in Auto', 3: 'Always Land' } },
  FS_THR_VALUE: { shortDescription: 'Throttle failsafe PWM value', units: 'PWM', min: 925, max: 1100 },
  FS_BATT_ENABLE: { shortDescription: 'Battery failsafe action', units: '', enumValues: { 0: 'Disabled', 1: 'Land', 2: 'RTL' } },
  ...
  FS_GCS_ENABLE: { shortDescription: 'GCS failsafe action', units: '', enumValues: { 0: 'Disabled', 1: 'Always RTL', 2: 'Continue in Auto' } },

  // Fence
  FENCE_ENABLE: { shortDescription: 'Enable geofence', units: '', enumValues: { 0: 'Disabled', 1: 'Enabled' } },
  ...
  FENCE_ACTION: { shortDescription: 'Fence breach action', units: '', enumValues: { 0: 'Report Only', 1: 'RTL or Land', 2: 'Always Land' } },

  // Arming
  ARMING_CHECK: { shortDescription: 'Pre-arm checks bitmask', units: '', min: 0, max: 65535 },

  // Frame
  FRAME_CLASS: { shortDescription: 'Frame class', units: '', enumValues: { 0: 'Undefined', 1: 'Quad', 2: 'Hexa', 3: 'Octa', 4: 'OctaQuad', 5: 'Y6', 6: 'Heli', 7: 'Tri', 9: 'Single', 10: 'Coax', 11: 'BiCopter', 12: 'Heli Dual', 13: 'DodecaHexa', 14: 'HeliQuad' } },
  FRAME_TYPE: { shortDescription: 'Frame type', units: '', enumValues: { 0: 'Plus', 1: 'X', 2: 'V', 3: 'H', 4: 'V-Tail', 5: 'A-Tail', 10: 'Y6B', 12: 'BetaFlightX', 13: 'DJIX', 14: 'ClockwiseX', 18: 'BetaFlightXReversed' } },
  ...
  SUPER_SIMPLE: { shortDescription: 'Super simple mode bitmask for flight modes', units: '', min: 0, max: 63 },

  // Board orientation
  AHRS_ORIENTATION: { shortDescription: 'Board orientation (rotation)', units: '', min: 0, max: 42 },
  ...
  RC1_REVERSED: { shortDescription: 'RC channel 1 reversed', units: '', enumValues: { 0: 'Normal', 1: 'Reversed' } },
  ...
  ATC_RAT_RLL_P: { shortDescription: 'Roll rate P gain', units: '', min: 0.001, max: 0.5, increment: 0.001 },
  ATC_RAT_RLL_I: { shortDescription: 'Roll rate I gain', units: '', min: 0, max: 2, increment: 0.01 },
  ATC_RAT_RLL_D: { shortDescription: 'Roll rate D gain', units: '', min: 0, max: 0.05, increment: 0.0001 },
  ATC_RAT_RLL_FF: { shortDescription: 'Roll rate feedforward', units: '', min: 0, max: 0.5, increment: 0.001 },
  ...
  ATC_RAT_PIT_P: { shortDescription: 'Pitch rate P gain', units: '', min: 0.001, max: 0.5, increment: 0.001 },
  ATC_RAT_PIT_I: { shortDescription: 'Pitch rate I gain', units: '', min: 0, max: 2, increment: 0.01 },
  ATC_RAT_PIT_D: { shortDescription: 'Pitch rate D gain', units: '', min: 0, max: 0.05, increment: 0.0001 },
  ATC_RAT_PIT_FF: { shortDescription: 'Pitch rate feedforward', units: '', min: 0, max: 0.5, increment: 0.001 },
  ...
  // PID Tuning — Yaw Rate
  ATC_RAT_YAW_P: { shortDescription: 'Yaw rate P gain', units: '', min: 0.001, max: 0.5, increment: 0.001 },
  ATC_RAT_YAW_I: { shortDescription: 'Yaw rate I gain', units: '', min: 0, max: 2, increment: 0.01 },
  ATC_RAT_YAW_D: { shortDescription: 'Yaw rate D gain', units: '', min: 0, max: 0.05, increment: 0.0001 },
  ATC_RAT_YAW_FF: { shortDescription: 'Yaw rate feedforward', units: '', min: 0, max: 0.5, increment: 0.001 },
  ...
  PSC_POSXY_P: { shortDescription: 'Position XY P gain', units: '', min: 0.5, max: 2, increment: 0.1 },
  PSC_VELXY_P: { shortDescription: 'Velocity XY P gain', units: '', min: 0.1, max: 6, increment: 0.1 },
  PSC_VELXY_I: { shortDescription: 'Velocity XY I gain', units: '', min: 0.02, max: 1, increment: 0.01 },
  PSC_VELXY_D: { shortDescription: 'Velocity XY D gain', units: '', min: 0, max: 1, increment: 0.001 },
  PSC_VELXY_FF: { shortDescription: 'Velocity XY feedforward', units: '', min: 0, max: 6, increment: 0.01 },
  ...
  PSC_ACCZ_P: { shortDescription: 'Accel Z P gain', units: '', min: 0.25, max: 0.8, increment: 0.01 },
  ...
  PSC_ACCZ_FF: { shortDescription: 'Accel Z feedforward', units: '', min: 0, max: 0.5, increment: 0.01 },
