...
import { CalibrationStatus, CalibrationOrientation } from '../../../../shared-types/ipc/SetupTypes'
...
function VehicleLevel(): React.JSX.Element {
  return (
    <svg width="120" height="100" viewBox="0 0 120 100">
      {/* Fuselage */}
      <path
        d="M60 8 L54 22 L54 68 L50 80 L70 80 L66 68 L66 22 Z"
        fill={`${V}0.85)`}
        stroke={`${V}0.3)`}
        strokeWidth="0.5"
      />
      ...
      {/* Right wing */}
      <path
        d="M66 40 L112 52 L112 56 L66 47 Z"
        fill={`${V}0.7)`}
        stroke={`${V}0.2)`}
        strokeWidth="0.5"
      />
      {/* Left tail */}
      <path
        d="M50 72 L32 78 L32 81 L50 76 Z"
        fill={`${V}0.5)`}
        stroke={`${V}0.15)`}
        strokeWidth="0.5"
      />
      {/* Right tail */}
      <path
        d="M70 72 L88 78 L88 81 L70 76 Z"
        fill={`${V}0.5)`}
        stroke={`${V}0.15)`}
        strokeWidth="0.5"
      />
      {/* Vertical stabilizer */}
      <path
        d="M57 66 L57 80 L63 80 L63 66 Z"
        fill={`${V}0.6)`}
        stroke={`${V}0.15)`}
        strokeWidth="0.5"
      />
  ...
  return (
    <svg width="120" height="100" viewBox="0 0 120 100">
      <g transform="rotate(-40 60 50)">
        <path
          d="M60 10 L55 22 L55 62 L52 72 L68 72 L65 62 L65 22 Z"
          fill={`${V}0.8)`}
          stroke={`${V}0.25)`}
          strokeWidth="0.5"
        />
        <path
          d="M55 36 L12 46 L12 50 L55 42 Z"
          fill={`${V}0.65)`}
          stroke={`${V}0.18)`}
          strokeWidth="0.5"
        />
        <path
          d="M65 36 L108 46 L108 50 L65 42 Z"
          fill={`${V}0.65)`}
          stroke={`${V}0.18)`}
          strokeWidth="0.5"
        />
        <path
          d="M52 66 L36 72 L36 74 L52 69 Z"
          fill={`${V}0.5)`}
          stroke={`${V}0.12)`}
          strokeWidth="0.5"
        />
        <path
          d="M68 66 L84 72 L84 74 L68 69 Z"
          fill={`${V}0.5)`}
          stroke={`${V}0.12)`}
          strokeWidth="0.5"
        />
...
function VehicleLeftSide(): React.JSX.Element {
  return (
    <svg width="120" height="100" viewBox="0 0 120 100">
      ...
      <path
        d="M18 48 L26 40 L85 38 L98 42 L100 48 L96 52 L85 54 L24 54 Z"
        fill={`${V}0.8)`}
        stroke={`${V}0.25)`}
        strokeWidth="0.5"
      />
      ...
      <path
        d="M40 54 L68 54 L64 62 L44 62 Z"
        fill={`${V}0.5)`}
        stroke={`${V}0.15)`}
        strokeWidth="0.5"
      />
      {/* Vertical stabilizer */}
      <path
        d="M88 38 L93 22 L100 22 L100 38 Z"
        fill={`${V}0.65)`}
        stroke={`${V}0.18)`}
        strokeWidth="0.5"
      />
      ...
      <path
        d="M88 42 L104 40 L106 42 L104 44 L88 44 Z"
        fill={`${V}0.45)`}
        stroke={`${V}0.12)`}
        strokeWidth="0.5"
      />
      ...
      {/* Cockpit canopy */}
      <path
        d="M32 40 L36 36 L46 36 L48 40 Z"
        fill={`${A}0.3)`}
        stroke={`${A}0.15)`}
        strokeWidth="0.5"
      />
